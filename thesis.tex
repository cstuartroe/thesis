...
% **************************************************
\newcommand{\thesisTitle}{The Effect of Linguistic Typology on \\Transfer Learning of Morphological Paradigms}
\newcommand{\thesisName}{Conor Stuart Roe}
\newcommand{\thesisDate}{\today}
\newcommand{\thesisVersion}{Draft 2\\Advisor: Jane Chandlee}
