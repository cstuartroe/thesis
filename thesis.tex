...
% **************************************************
\newcommand{\thesisTitle}{The Effect of Linguistic Typology on \\Transfer Learning of Morphology}
\newcommand{\thesisName}{Conor Stuart Roe}
\newcommand{\thesisDate}{\today}
\newcommand{\thesisVersion}{Final\\Advisor: Jane Chandlee}
\newcommand{\thesisLink}{https://github.com/cstuartroe/thesis}
